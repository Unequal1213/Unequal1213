...
![Инженерные доказательства: тесты, миграции, очереди, повторные попытки, идемпотентность, структурированные AI-ответы, PII-границы, Docker и CI](assets/evidence.svg)
